                                        ...
                                        <div className="row gy-3 overflow-hidden">
                                            <div className="col-6">
                                                <div className="form-floating mb-3">
                                                    <input type="username" className="form-control" name="username" id="username" placeholder="name@example.com" required />
                                            ...
                                            <div className="col-6">
                                                <div className="form-floating mb-3">
                                                    <input type="phone" className="form-control" name="phone" id="phone" placeholder="name@example.com" required />
                                                    <label htmlFor="phone" className="form-label">Số điện thoại</label>
                                                </div>
                                            </div>
                                            <div className="col-6">
                                                <div className="form-floating mb-3">
                                                    <input type="name" className="form-control" name="name" id="name" placeholder="name@example.com" required />
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                                <NavLink to="/" className="link-secondary text-decoration-none">Quay lại</NavLink>
                                                <NavLink to="/login" className="link-secondary text-decoration-none" type="submit">Đăng nhập</NavLink>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
