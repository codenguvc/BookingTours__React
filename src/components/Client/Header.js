        ...
        <div className={`mobile__menu ${isMobileMenuOpen ? "open" : ""} d-lg-none`}>
          ...
          <nav className="header__menu">
            <ul className="menu__class">
              ...
              <div className="col-md-12">
              <li>
                <NavLink to="/product" onClick={closeMobileMenu}>Chuyến đi</NavLink>
              </li>
              </div>
              <div className="col-md-12">
              <li>
                <NavLink to="/aboutus" onClick={closeMobileMenu}>Về chúng tôi</NavLink>
              </li>
              </div>
              <div className="col-md-12">
              <li>
                <NavLink to="/news" onClick={closeMobileMenu}>Tin tức</NavLink>
              </li>
              </div>
              <div className="col-md-12">
              <li>
                <NavLink to="/contact" onClick={closeMobileMenu}>Liên hệ</NavLink>
              </li>
              </div>
            </ul>
          </nav>
