                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                                <NavLink to="/register" className="link-secondary text-decoration-none">Đăng ký</NavLink>
                                                <NavLink to="#!" className="link-secondary text-decoration-none">Quên mật khẩu</NavLink>
